...
console.log("sortttt",someValue.value);
this.sorting=someValue.value
//console.log("sortttt line 227",someValue.target.value);
    switch (someValue.value){
    case "low":{
    this.productItem = this.productItem.sort((low, high) => low.price - high.price)
    break;
    }
    case "high":{
    this.productItem = this.productItem.sort((low, high) => high.price - low.price)
    break;
    }
    case "none":{
    this.productItem = this.productUnsortedInfo;
    }
    default:{
    this.productItem = this.productItem.sort((low, high) => low.price - high.price)
    break;
